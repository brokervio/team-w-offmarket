...
export default function ShareActions({ listingId, addressLine, town }: {
  listingId: string; addressLine: string; town: string;
}) {
  ...
  return (
    <div className="card p-5">
      ...
      <div className="mt-3 space-y-2">
        ...
        <Link href={`/listing/${listingId}/flyer`} className="btn-secondary w-full !py-2 text-sm">
